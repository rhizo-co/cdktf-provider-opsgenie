// https://registry.terraform.io/providers/opsgenie/opsgenie/0.6.33/docs/data-sources/team
...
export interface DataOpsgenieTeamConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly member?: DataOpsgenieTeamMember[] | cdktf.IResolvable;
}
export interface DataOpsgenieTeamMember {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opsgenie/opsgenie/0.6.33/docs/data-sources/team#id DataOpsgenieTeam#id}
  *
  * Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2.
...
export function dataOpsgenieTeamMemberToTerraform(struct?: DataOpsgenieTeamMember | cdktf.IResolvable): any {
...
export class DataOpsgenieTeamMemberOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataOpsgenieTeamMember | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataOpsgenieTeamMember | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataOpsgenieTeamMemberList extends cdktf.ComplexList {
  public internalValue? : DataOpsgenieTeamMember[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataOpsgenieTeamMemberOutputReference {
    return new DataOpsgenieTeamMemberOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class DataOpsgenieTeam extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opsgenie/opsgenie/0.6.33/docs/data-sources/team opsgenie_team} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataOpsgenieTeamConfig
  */
  public constructor(scope: Construct, id: string, config: DataOpsgenieTeamConfig) {
    super(scope, id, {
  ...
  private _member = new DataOpsgenieTeamMemberList(this, "member", false);
  public get member() {
    return this._member;
  }
  public putMember(value: DataOpsgenieTeamMember[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      member: cdktf.listMapper(dataOpsgenieTeamMemberToTerraform, true)(this._member.internalValue),
    };
  }
}
